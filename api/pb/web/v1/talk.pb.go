...
func (x *TalkSessionTopResponse) GetIsTop() int32 {
	if x != nil {
		return x.IsTop
	}
	return 0
...
type TalkSessionDisturbResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsDisturb     int32                  `protobuf:"varint,1,opt,name=is_disturb,json=isDisturb,proto3" json:"is_disturb,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TalkSessionDisturbResponse) GetIsDisturb() int32 {
	if x != nil {
		return x.IsDisturb
	}
	return 0
...
// 会话详情接口请求参数
type TalkSessionDetailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TalkMode      int32                  `protobuf:"varint,1,opt,name=talk_mode,json=talkMode,proto3" json:"talk_mode,omitempty"`
	ToFromId      int32                  `protobuf:"varint,2,opt,name=to_from_id,json=toFromId,proto3" json:"to_from_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *TalkSessionDetailRequest) Reset() {
	*x = TalkSessionDetailRequest{}
	mi := &file_web_v1_talk_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TalkSessionDetailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TalkSessionDetailRequest) ProtoMessage() {}

func (x *TalkSessionDetailRequest) ProtoReflect() protoreflect.Message {
	mi := &file_web_v1_talk_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TalkSessionDetailRequest.ProtoReflect.Descriptor instead.
func (*TalkSessionDetailRequest) Descriptor() ([]byte, []int) {
	return file_web_v1_talk_proto_rawDescGZIP(), []int{9}
}

func (x *TalkSessionDetailRequest) GetTalkMode() int32 {
	if x != nil {
		return x.TalkMode
	}
	return 0
...
func (x *TalkSessionDetailRequest) GetToFromId() int32 {
	if x != nil {
		return x.ToFromId
	}
	return 0
...
func (x *TalkSessionDetailResponse) Reset() {
	*x = TalkSessionDetailResponse{}
	mi := &file_web_v1_talk_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TalkSessionDetailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TalkSessionDetailResponse) ProtoMessage() {}

func (x *TalkSessionDetailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_web_v1_talk_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TalkSessionDetailResponse.ProtoReflect.Descriptor instead.
func (*TalkSessionDetailResponse) Descriptor() ([]byte, []int) {
	return file_web_v1_talk_proto_rawDescGZIP(), []int{10}
}

func (x *TalkSessionDetailResponse) GetIsTop() int32 {
	if x != nil {
		return x.IsTop
	}
	return 0
...
func (x *TalkSessionDetailResponse) GetIsDisturb() int32 {
	if x != nil {
		return x.IsDisturb
	}
	return 0
...
const file_web_v1_talk_proto_rawDesc = "" +
	...
	"\x06action\x18\x03 \x01(\x05B\t\xbaH\x06\x1a\x040\x010\x02R\x06action\"5\n" +
	"\x16TalkSessionTopResponse\x12\x1b\n" +
	"\x06is_top\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\x05isTop\"\x8d\x01\n" +
	"\x19TalkSessionDisturbRequest\x12&\n" +
	"\ttalk_mode\x18\x01 \x01(\x05B\t\xbaH\x06\x1a\x040\x010\x02R\btalkMode\x12%\n" +
	"\n" +
	"to_from_id\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\btoFromId\x12!\n" +
	"\x06action\x18\x03 \x01(\x05B\t\xbaH\x06\x1a\x040\x010\x02R\x06action\"A\n" +
	"\x1aTalkSessionDisturbResponse\x12#\n" +
	"\n" +
	"is_disturb\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\tisDisturb\"i\n" +
