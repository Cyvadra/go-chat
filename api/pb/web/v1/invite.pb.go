...
const file_web_v1_invite_proto_rawDesc = "" +
	...
	"\x15InviteDisableResponse2\xb5\x03\n" +
	"\x06Invite\x12q\n" +
	...
	"\x11DisableInviteCode\x12\x19.web.InviteDisableRequest\x1a\x1a.web.InviteDisableResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/api/v1/invite/disableB\fZ\n" +
...
var file_web_v1_invite_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_web_v1_invite_proto_depIdxs = []int32{
	...
	0, // 1: web.Invite.GenerateInviteCode:input_type -> web.InviteGenerateRequest
	2, // 2: web.Invite.GetMyInviteCodes:input_type -> web.InviteListRequest
	5, // 3: web.Invite.GetInviteStats:input_type -> web.InviteStatsRequest
	7, // 4: web.Invite.DisableInviteCode:input_type -> web.InviteDisableRequest
	1, // 5: web.Invite.GenerateInviteCode:output_type -> web.InviteGenerateResponse
	3, // 6: web.Invite.GetMyInviteCodes:output_type -> web.InviteListResponse
	6, // 7: web.Invite.GetInviteStats:output_type -> web.InviteStatsResponse
	8, // 8: web.Invite.DisableInviteCode:output_type -> web.InviteDisableResponse
