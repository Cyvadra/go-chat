...
const file_web_v1_auth_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\vaccessToken\x12#\n" +
	"\n" +
	"expires_in\x18\x03 \x01(\x05B\x04\xe2A\x01\x02R\texpiresIn\"\x19\n" +
	...
	"\faccess_token\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\vaccessToken\x12#\n" +
	"\n" +
	"expires_in\x18\x03 \x01(\x05B\x04\xe2A\x01\x02R\texpiresIn2\xa6\x06\n" +
	"\x04Auth\x12U\n" +
	...
	"\fRefreshToken\x12\x1c.web.AuthRefreshTokenRequest\x1a\x1d.web.AuthRefreshTokenResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/api/v1/auth/refresh-tokenB\fZ\n" +
...
var file_web_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_web_v1_auth_proto_goTypes = []any{
	...
	(*AuthRefreshTokenRequest)(nil),  // 4: web.AuthRefreshTokenRequest
	(*AuthRefreshTokenResponse)(nil), // 5: web.AuthRefreshTokenResponse
	(*AuthForgetRequest)(nil),        // 6: web.AuthForgetRequest
	(*AuthForgetResponse)(nil),       // 7: web.AuthForgetResponse
	(*AuthOauthRequest)(nil),         // 8: web.AuthOauthRequest
	(*AuthOauthResponse)(nil),        // 9: web.AuthOauthResponse
	(*AuthOauthLoginRequest)(nil),    // 10: web.AuthOauthLoginRequest
	(*AuthOauthLoginResponse)(nil),   // 11: web.AuthOauthLoginResponse
	(*Authorize)(nil),                // 12: web.Authorize
	(*AuthOAuthBindRequest)(nil),     // 13: web.AuthOAuthBindRequest
	(*AuthOAuthBindResponse)(nil),    // 14: web.AuthOAuthBindResponse
	(*AuthEmailLoginRequest)(nil),    // 15: web.AuthEmailLoginRequest
	(*AuthEmailLoginResponse)(nil),   // 16: web.AuthEmailLoginResponse
}
var file_web_v1_auth_proto_depIdxs = []int32{
	12, // 0: web.AuthOauthLoginResponse.authorize:type_name -> web.Authorize
	12, // 1: web.AuthOAuthBindResponse.authorize:type_name -> web.Authorize
	0,  // 2: web.Auth.Login:input_type -> web.AuthLoginRequest
	2,  // 3: web.Auth.Register:input_type -> web.AuthRegisterRequest
	6,  // 4: web.Auth.Forget:input_type -> web.AuthForgetRequest
	8,  // 5: web.Auth.Oauth:input_type -> web.AuthOauthRequest
	13, // 6: web.Auth.OauthBind:input_type -> web.AuthOAuthBindRequest
	10, // 7: web.Auth.OauthLogin:input_type -> web.AuthOauthLoginRequest
	15, // 8: web.Auth.EmailLogin:input_type -> web.AuthEmailLoginRequest
	4,  // 9: web.Auth.RefreshToken:input_type -> web.AuthRefreshTokenRequest
	1,  // 10: web.Auth.Login:output_type -> web.AuthLoginResponse
	3,  // 11: web.Auth.Register:output_type -> web.AuthRegisterResponse
	7,  // 12: web.Auth.Forget:output_type -> web.AuthForgetResponse
	9,  // 13: web.Auth.Oauth:output_type -> web.AuthOauthResponse
	14, // 14: web.Auth.OauthBind:output_type -> web.AuthOAuthBindResponse
	11, // 15: web.Auth.OauthLogin:output_type -> web.AuthOauthLoginResponse
	16, // 16: web.Auth.EmailLogin:output_type -> web.AuthEmailLoginResponse
	5,  // 17: web.Auth.RefreshToken:output_type -> web.AuthRefreshTokenResponse
