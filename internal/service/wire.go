...
var ProviderSet = wire.NewSet(
	...
	// InMemoryRedEnvelopeService uses a constructor function because its internal state
	// (map, mutex) must be initialized, not zero-value struct.
	NewInMemoryRedEnvelopeService,
